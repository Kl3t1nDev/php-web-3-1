...
<body>
    <div class="container mt-4">
        ...
        <?php else: ?>
            <a href="index.php?entity=orcamento&action=create" class="btn btn-primary mb-3">Adicionar Novo Orçamento</a>
        <?php endif; ?>
                    ...
                    <?php foreach ($orcamentos as $orcamento): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="index.php?entity=orcamento&action=delete&id=<?= htmlspecialchars($orcamento['id']) ?>&cliente_id=<?= htmlspecialchars($cliente_id) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja deletar?')">Deletar</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
